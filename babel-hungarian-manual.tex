...
\author{%
  ...
  \href{https://math.bme.hu/latex/magyarldf-doc.pdf}{Typing Hungarian text with Magyar\LaTeX}%
  ...
  and\\
  \href{https://math.bme.hu/latex/dl/pts_tug2004_magyarldf2.pdf}{Implementation Tricks in the Hungarian Babel Module}\\
  by \textsc{Péter Szabó}
  }
...
Csak \texttt{classmod=yes} esetén van hatása.
\item[unchanged]
Nem történik módosítás.
\end{hunopt}
...
\item[\param{hosszúságparancs}]
A szakasz, alszakasz, stb. szedésekor a sorszám után pontot rak.
A \param{hosszúságparancs} a pont és a cím közötti térközt adja meg.
\item[unchanged]
Nem történik módosítás.
\end{hunopt}
